<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucDataField.ascx.cs"
    Inherits="HarunaNet.SisWeb.webUserControl.ucDataField" %>
...
<ajax:CalendarExtender ID="ceData" runat="server" TargetControlID="txtData" Format="dd/MM/yyyy"
    PopupButtonID="imgData" CssClass="Calendario" Enabled="True">
...
<ajax:ValidatorCalloutExtender ID="vceData" Width="170px" runat="server" TargetControlID="revData"
    WarningIconImageUrl="~/library/imagens/alert-small.gif">
